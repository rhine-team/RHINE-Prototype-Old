...
replace github.com/rhine-team/RHINE-Prototype/offlineAuth => ../../../offlineAuth
...
require (
	...
	github.com/rhine-team/RHINE-Prototype/offlineAuth v0.0.0-00010101000000-000000000000
